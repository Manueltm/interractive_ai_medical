// app/dashboard/components/mocks/MiniMockOSCE.tsx
'use client';
...
const MiniMockOSCE: FC<MiniMockOSCEProps> = ({ categoryId, onStatsUpdate }) => {
  ...
  const fetchItems = async () => {
    setIsLoading(true);
    try {
      const url = new URL('/api/mini-mock-osce', window.location.origin);
      ...
      console.error('Error fetching mini mock OSCE items:', error);
